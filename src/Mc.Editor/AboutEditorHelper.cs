...
/// <summary>
/// About menu document viewer for the editor (self-contained — Mc.Editor does not
/// reference Mc.Ui, so we duplicate the thin viewer implementation here).
/// </summary>
internal static class AboutEditorHelper
{
